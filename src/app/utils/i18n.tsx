...
export const TRANSLATIONS: Dict = {
  ...
  "game.bp.msg.safeToTrash": { en: "Wait! Your body needs this formula for energy. Put it in the sport bag.", de: "Warte! Dein Körper braucht diese Formel für Energie. Pack es in die Sporttasche." },
  ...
  "runner.intro": {
    en: "During physical exertion, like sports or active day trips, your body needs fuel! Running without it means your body extracts protein from your muscles for energy, causing your Phe Level to rise. Avoid heavy protein on the track, and catch formula to clear your mind.",
    de: "Bei körperlicher Anstrengung, wie beim Sport oder aktiven Ausflügen, braucht dein Körper Energie! Ohne Treibstoff gewinnt dein Körper Eiweiß aus den Muskeln für Energie, wodurch dein Phe-Spiegel steigt. Vermeide schweres Protein und fang die Formel, um einen klaren Kopf zu behalten.",
  },
  ...
  "food.nuts.name": { en: "Nuts", de: "Nüsse" },
  "food.nuts.label": { en: "High protein", de: "Viel Protein" },
  ...
  "fact.0.text": { en: "Whether you play soccer, swim, or dance, your routine doesn't differ from other athletes. Just pack your sport bag before training and you are good to go! Talk with your doctor whether additional formula for sporty days would be good for you.", de: "Egal, ob du Fußball spielst, schwimmst oder tanzt, deine Routine unterscheidet sich nicht von der anderer Athleten. Packe einfach deine Sporttasche vor dem Training und schon kann es losgehen! Sprich mit deinem Arzt darüber, ob an sportlichen Tagen zusätzliche Formel für dich gut wäre." },
  ...
  "fact.2.title": { en: "Formula Timing", de: "Formel-Timing" },
  "fact.2.short": { en: "Drink it throughout the day.", de: "Trinke sie über den Tag verteilt." },
  "fact.2.text": { en: "You don't have to drink your Formula right before the whistle! Taking it regularly throughout the entire day keeps your muscles strong for any sports activity. Take your formula at several time points over the day and best together with a meal.", de: "Du musst deine Formel nicht direkt vor dem Pfiff trinken! Wenn du sie regelmäßig über den ganzen Tag verteilt zu dir nimmst, bleiben deine Muskeln für jede sportliche Aktivität stark. Nimm deine Formel zu mehreren Zeitpunkten über den Tag verteilt und am besten zusammen mit einer Mahlzeit ein." },
  ...
  "fact.3.text": { en: "A sports bag always needs water, and a low-protein snack approved by your parents to keep your stamina up during half-time.", de: "In eine Sporttasche gehören immer Wasser und ein von deinen Eltern genehmigter eiweißarmer Snack, um deine Ausdauer in der Halbzeit aufrechtzuerhalten." },
