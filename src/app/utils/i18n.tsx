...
export const TRANSLATIONS: Dict = {
  ...
  "fact.2.text": { en: "You don't have to drink your Super-Fuel right before the whistle! Taking it regularly throughout the entire day keeps your muscles strong for any sports activity. Take your formula at several times points over the day and best together with a meal.", de: "Du musst deinen Super-Treibstoff nicht direkt vor dem Pfiff trinken! Wenn du ihn regelmäßig über den ganzen Tag verteilt zu dir nimmst, bleiben deine Muskeln für jede sportliche Aktivität stark. Nimm deine Formel zu mehreren Zeitpunkten über den Tag verteilt und am besten zusammen mit einer Mahlzeit ein." },
